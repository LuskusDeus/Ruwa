...
static const RuwaEffectCapabilities k_twirl_caps = {
    sizeof(RuwaEffectCapabilities), RUWA_TRUE, /* supports_document_tile   */
...
#define CENTER_X_PARAM                                                                             \
    {                                                                                              \
        ...
        .max_value = 16384.0,                                                                      \
        .step_value = 1.0,                                                                         \
        .preferred_editor = RUWA_EFFECT_EDITOR_NUMBER_FIELD,                                       \
        .position_pair_key = "center",                                                             \
...
static const RuwaEffectParamDef k_twirl_params[] = {
    ...
    },
    {
        ...
        .key = "radius",
        .label = "Radius",
        .type = RUWA_EFFECT_PARAM_INT,
        .default_value = 200.0,
        .min_value = 0.0,
        .max_value = (double) TWIRL_MAX_RADIUS,
        .step_value = 1.0,
        .preferred_editor = RUWA_EFFECT_EDITOR_SLIDER,
    },
};
...
static const RuwaEffectParamDef k_pinch_params[] = {
    ...
    },
    {
        ...
        .default_value = 240.0,
        .min_value = 0.0,
        .max_value = (double) PINCH_MAX_RADIUS,
        .step_value = 1.0,
        .preferred_editor = RUWA_EFFECT_EDITOR_SLIDER,
    },
};
...
static const RuwaEffectParamDef k_ripple_params[] = {
    ...
    CENTER_Y_PARAM,
    {
        ...
        .default_value = 16.0,
        .min_value = 0.0,
        .max_value = (double) RIPPLE_MAX_AMPLITUDE,
        .step_value = 1.0,
        .preferred_editor = RUWA_EFFECT_EDITOR_SLIDER,
    },
    {
        ...
        .default_value = 80.0,
        .min_value = 1.0,
        .max_value = (double) RIPPLE_MAX_WAVELENGTH,
        .step_value = 1.0,
        .preferred_editor = RUWA_EFFECT_EDITOR_SLIDER,
    },
    {
        ...
        .default_value = 512.0,
        .min_value = 0.0,
        .max_value = (double) RIPPLE_MAX_RADIUS,
        .step_value = 1.0,
        .preferred_editor = RUWA_EFFECT_EDITOR_SLIDER,
    },
    {
...
static const RuwaEffectParamDef k_wave_params[] = {
    {
        ...
        .default_value = 20.0,
        .min_value = 0.0,
        .max_value = (double) WAVE_MAX_AMPLITUDE,
        .step_value = 1.0,
        .preferred_editor = RUWA_EFFECT_EDITOR_SLIDER,
    },
    {
        ...
        .default_value = 120.0,
        .min_value = 1.0,
        .max_value = (double) WAVE_MAX_WAVELENGTH,
        .step_value = 1.0,
        .preferred_editor = RUWA_EFFECT_EDITOR_SLIDER,
    },
    {
...
/* Twirl, Pinch and Ripple share the same document-space center/radius schema,
 * so one declarative control table serves all three descriptors. */
static const RuwaEffectCanvasControlDef k_center_radius_controls[] = {
    {
        .struct_size = sizeof(RuwaEffectCanvasControlDef),
        .id = "radius",
        .type = RUWA_EFFECT_CANVAS_CONTROL_CIRCLE,
        .value_key = "radius",
