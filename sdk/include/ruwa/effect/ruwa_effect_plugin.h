...
typedef struct RuwaEffectDescriptor {
    ...
    RuwaBool(RUWA_EFFECT_CALL* resolve_coverage)(void* user_data, const RuwaEffectStateView* state,
...
typedef struct RuwaEffectHostApi {
    ...
    RuwaTileKey(RUWA_EFFECT_CALL* coverage_input_at)(RuwaEffectCoverageInput input, uint32_t index);
