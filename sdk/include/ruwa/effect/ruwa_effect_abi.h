...
#define RUWA_EFFECT_ABI_MINOR 2u
...
enum { RUWA_EFFECT_EDITOR_SLIDER = 0, RUWA_EFFECT_EDITOR_NUMBER_FIELD = 1 };

/* Mirrors EffectParamPositionAxis. */
typedef int32_t RuwaEffectPositionAxis;
enum { RUWA_EFFECT_AXIS_X = 0, RUWA_EFFECT_AXIS_Y = 1 };
...
enum {
    RUWA_EFFECT_CANVAS_CONTROL_CIRCLE = 0,
    RUWA_EFFECT_CANVAS_CONTROL_POSITION = 1 /* ABI 1.2 */
};

/* Mirrors EffectEvaluationSpace. */
typedef int32_t RuwaEffectEvaluationSpace;
enum { RUWA_EFFECT_SPACE_DOCUMENT_TILE = 0, RUWA_EFFECT_SPACE_VIEWPORT_SCREEN = 1 };
...
enum { RUWA_EFFECT_STAGE_FRAGMENT = 0, RUWA_EFFECT_STAGE_COMPUTE = 1 };

typedef int32_t RuwaEffectSamplerFilter;
enum { RUWA_EFFECT_FILTER_NEAREST = 0, RUWA_EFFECT_FILTER_LINEAR = 1 };
