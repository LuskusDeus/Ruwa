    ...
    BrushPreviewSession::Kind kind, const BrushPreviewSpec& spec) const
{
    ...
    return joinKeyParts({
        ...
        QString::number(settings.textureMode),
        QString::number(settings.textureType),
        n3(settings.texturePencilDetail),
        n3(settings.texturePencilStreakStrength),
        n3(settings.textureNoiseOctaves),
        n3(settings.textureNoiseRoughness),
        n3(settings.texturePerlinOctaves),
        n3(settings.texturePerlinPersistence),
        n3(settings.textureDotsSpacing),
        n3(settings.textureDotsSize),
        n3(settings.textureDotsJitter),
        n3(settings.textureLinesSpacing),
        n3(settings.textureLinesThickness),
        n2(settings.textureLinesAngle),
        n3(settings.textureCheckerSize),
        n3(settings.textureCheckerSoftness),
        n2(settings.textureCheckerRotation),
